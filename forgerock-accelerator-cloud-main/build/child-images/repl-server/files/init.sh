...
# on startup to configure itself as a ForgeRock Directory Server (Replication
# Server).
...
# Local Variables
# ---------------
path_secretsUS="/opt/ds/secrets/us"
path_secretsTS="/opt/ds/secrets/ts"
path_secretsAPS="/opt/ds/secrets/aps"
