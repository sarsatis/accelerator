...
image="${CI_REGISTRY_URL}/forgerock-access-manager:${IMAGES_TAG_SRC}"
...
inspect_image_environment "${image}" \
  ...
  "PASSED - CERT_ALIAS env var exists and set to 'access-manager'" \
  "FAILED - CERT_ALIAS env var missing or not set to 'access-manager'"
